...
from bim_agent.kernel.feedback_collector import FeedbackCollector
from bim_agent.llm.reflection_prompt import build_reflection_user_message
from bim_agent.llm.response_schema import LLMResponseValidator
from bim_agent.state import AgentState, ChecklistItem
...
async def _run_reflection(state, cfg, agent_config, reflect_every: int = 1) -> Dict[str, Any]:
    ...
    from bim_agent.nodes.llm_step_node import _state_messages_to_openai
